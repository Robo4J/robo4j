...
public class CommandProviderImpl extends DefaultUnit implements CommandProvider  {
    ...
    public CommandProviderImpl() {
        ...
        final RoboRegistry<RoboRegistry, RoboSystemConfig> unitRegistry = RegistryManager.getInstance().getRegistryByType(RegistryTypeEnum.UNITS);
        unitRegistry.getRegistry().entrySet()
                .forEach(entry -> {
