 ...
 */
public class SchedulePeriodUnit extends RoboUnit<Boolean> {
    ...
    public SchedulePeriodUnit(RoboContext context, String id) {
    ...
    private void runUnit(){
        ...
        getContext().getScheduler().schedule(unitReference, true,
                (int)properties.get(FIELD_DELAY), (int) properties.get(FIELD_PERIOD),
                (TimeUnit)properties.get(FIELD_TIME_UNIT));
    }
