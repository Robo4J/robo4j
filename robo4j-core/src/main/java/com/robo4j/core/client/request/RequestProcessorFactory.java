...
import com.robo4j.core.concurrent.LegoThreadFactory;
import com.robo4j.core.control.RoboSystemConfig;
import com.robo4j.core.http.RequestHeaderProcessor;
...
import com.robo4j.core.unit.BrainUnit;
							...
							if (!u.getActive()) {
								try {
									commandQueue.put(Collections
											.singletonList(new ClientMotorCommandRequestDTO(PlatformUnitCommandEnum.STOP)));
