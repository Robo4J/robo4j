...
public abstract class RoboUnit<T> implements RoboReference<T> {
     ...
     * @throws ConfigurationException possible exception
     */
    ...
    protected Map<AttributeDescriptor<?>, Object> onGetAttributes() {
        var result = new HashMap<AttributeDescriptor<?>, Object>();
     ...
     *
     * @param descriptor the descriptor for which to return the attribute.
     * @param <R>        attribute descriptor
    ...
    public boolean equals(Object object) {
        ...
        RoboUnit<?> roboUnit = (RoboUnit<?>) object;
        return Objects.equals(id, roboUnit.id);
    }
