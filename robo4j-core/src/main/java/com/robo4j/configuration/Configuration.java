...
public interface Configuration extends Serializable {
     ...
     *
     * @param name the name of the child configuration to retrieve.
     ...
     * @param defaultValue the default value if no value is set. Use null if you wish to
     ...
     *
     * @param name         the name of the Long to retrieve.
     * @param defaultValue the default value if no value is set. Use null if you wish to
     *                     discover that no value was set.
     * @return the value stored under the specified name, or defaultValue if no
     * such value could be found.
     ...
     * @param character the default value if no value is set. Use null if you wish to
     *                  discover that no value was set.
     * @return the value stored under the specified name, or defaultValue if no
     * such value could be found.
     */
     ...
     * @param defaultValue the default value retrieved.
     * @return the value stored under the specified name, or defaultValue if no
     * such value could be found.
     */
    ...
    /**
     * @return any of config parameters is set
     */
    boolean isDefined();
}
