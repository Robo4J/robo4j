...
public class RemoteSystemBuilderTest {
	...
	public void builderRemoteSystemTest() throws RoboBuilderException {
        ...
        final Configuration systemConf = new ConfigurationBuilder()
                .addInteger(RoboSystemUtil.KEY_SCHEDULER_POOL_SIZE, 2)
                .addInteger(RoboSystemUtil.KEY_WORKER_POOL_SIZE, 2)
                .addInteger(RoboSystemUtil.KEY_BLOCKING_POOL_SIZE, 6)
                .addBuilder(RoboSystemUtil.KEY_CONFIGURATION_SERVER, new ConfigurationBuilder()
                        .addString("hostname", "localhost")
                        .addInteger("port", 0))
                .addBuilder(RoboSystemUtil.KEY_CONFIGURATION_EMITTER, new ConfigurationBuilder()
                        .addString("multicastAddress", "238.12.15.254")
                        .addInteger("port", 0x0FFE)
                        .addInteger("heartBeatInterval", 250)
                        .addBoolean("enabled", true)
                        .addBuilder(RoboSystemUtil.KEY_CONFIGURATION_EMITTER_METADATA, new ConfigurationBuilder()
