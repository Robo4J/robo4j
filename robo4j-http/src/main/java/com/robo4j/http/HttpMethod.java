...
public enum HttpMethod implements Comparator<HttpMethod> {
     ...
     * The final recipient of the request SHOULD reflect the message received back to the client as
     * the entity-body of a 200 (OK) response.
     */
    TRACE    ("TRACE"),

    /**
     * The OPTIONS method represents a request for information about the communication options available on
     * the request/response chain identified by the Request-URI. This method allows the client to
     * determine the options and/or requirements associated with a resource, or the capabilities of a server,
