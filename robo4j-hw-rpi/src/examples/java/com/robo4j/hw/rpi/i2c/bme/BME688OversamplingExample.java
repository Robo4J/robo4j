...
public class BME688OversamplingExample {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("BME688 Oversampling Configuration Example");
        System.out.println("==========================================");
        System.out.println();

        // Configuration 1: Ultra-low power (1x oversampling for all)
        System.out.println("--- Ultra-Low Power Mode (1x oversampling) ---");
        ...
        System.out.println("--- Standard Mode (2x/4x/2x oversampling) ---");
        ...
        System.out.println("--- High Resolution Mode (16x oversampling) ---");
        ...
        System.out.println("--- Weather Monitoring Mode (no humidity) ---");
    ...
    private static void testConfiguration(Oversampling tempOs, Oversampling pressOs,
        ...
        System.out.printf("Configuration: %s - T:%dx, P:%dx, H:%dx%n",
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            System.out.printf("  Reading %d: T=%.2f C, P=%.2f hPa, H=%.2f%%%n",
