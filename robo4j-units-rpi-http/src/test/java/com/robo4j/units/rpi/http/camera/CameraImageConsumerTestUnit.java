...
public class CameraImageConsumerTestUnit extends RoboUnit<CameraMessage> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CameraImageConsumerTestUnit.class);
    ...
    public void onMessage(CameraMessage message) {
        if (message.getImage() != null) {
            ...
            LOGGER.info(" Delivered image: {} size: {} imageSize: {}", counter.incrementAndGet(), bytes.length, message.getImage().length());
