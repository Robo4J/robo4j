 ...
 */
public final class ServerContentBuilder {

    private final List<ServerUnitPathDTO> paths;

    private ServerContentBuilder(){
        this.paths = new LinkedList<>();
    }

    public static ServerContentBuilder Builder(){
        return new ServerContentBuilder();
    }

    public ServerContentBuilder addPaths(Collection<ServerUnitPathDTO> paths){
    ...
    public ServerContext build(RoboContext context){
        ...
        resultPaths.put(Utf8Constant.UTF8_SOLIDUS, new ServerPathConfig(Utf8Constant.UTF8_SOLIDUS, null, HttpMethod.GET));
