...
class JsonReaderArrayTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(JsonReaderArrayTests.class);
    ...
    void basicArrayStringOnlyTest() {
        var parser = new JsonReader(jsonArrayStringOnly);
        var document = parser.read();
        var testArray = Arrays.asList("one", "two", "three");
    ...
    void basicArrayIntegerOnlyTest() {
        var parser = new JsonReader(jsonArrayIntegerOnly);
        var document = parser.read();
        var testArray = Arrays.asList(1, 2, 3, 4, 5, 6, 7);
    ...
    void basicArrayNumberOnlyTest() {
        var parser = new JsonReader(jsonArrayNumberOnly);
        var document = parser.read();
        var testArray = Arrays.asList(0.2, 0.1, 0.3);
