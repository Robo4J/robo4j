...
import com.robo4j.socket.http.test.units.config.enums.CommunicationType;
...
public class SocketMessageDecoratedProducerUnit extends RoboUnit<Integer> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SocketMessageDecoratedProducerUnit.class);
     ...
     *
     * @param number number of get messages
     */
    @Override
