 ...
 */
package com.robo4j.socket.http.test.request;
...
class ByteBufferTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(ByteBufferTests.class);
    ...
    void testPostmanMessage() {
        ...
        assertFalse(decoratedRequest.getHeader().isEmpty());
        assertNotNull(decoratedRequest.getMessage());
        LOGGER.debug("HEADER:{}", decoratedRequest.getHeader());
        LOGGER.debug("BODY:{}", decoratedRequest.getMessage());
    ...
    void test() {
        ...
        // Assert.assertTrue(matcher2.groupCount() == matcher1.groupCount());
        LOGGER.debug("ONE: {} group: {} 1: {} 2: {}", matcher1.find(), matcher1.groupCount(), matcher1.group(1), matcher1.group(0));
        LOGGER.debug("TWO: {} group: {}", matcher2.find(), matcher2.groupCount());
