...
#
export ROBO4J_PATH=PI4J_HOME/*:$ROBO4J_HOME/robo4j-math/build/libs/robo4j-math-alpha-$ROBO4J_VERSION.jar:$ROBO4J_HOME/robo4j-core/build/libs/robo4j-core-alpha-$ROBO4J_VERSION.jar:$ROBO4J_HOME/robo4j-hw-rpi/build/libs/robo4j-hw-rpi-alpha-$ROBO4J_VERSION.jar:$ROBO4J_HOME/robo4j-units-rpi/build/libs/robo4j-units-rpi-alpha-$ROBO4J_VERSION.jar 
